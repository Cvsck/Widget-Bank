...
def test_transaction_descriptions():
    ...
    expected_resul = ['Перевод организации', 'Перевод со счета на счет', 'Перевод с карты на карту']

    assert list(transaction_descriptions(usd_transactions)) == expected_resul
